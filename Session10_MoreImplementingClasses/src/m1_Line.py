...
class Line(object):
    ...
    def clone(self):
        ...
        self.countofclones = self.countofclones + 1
    ...
    def line_plus(self, other_line):
        ...
        ssx = self.start.x + other_line.start.x
        ssy = self.start.y + other_line.start.y
        eex = self.end.x + other_line.end.x
        eey = self.end.y + other_line.end.y
        return Line(Point(ssx, ssy), Point(eex, eey))
    ...
    def line_minus(self, other_line):
        ...
        sssx = self.start.x - other_line.start.x
        sssy = self.start.y - other_line.start.y
        eeex = self.end.x - other_line.end.x
        eeey = self.end.y - other_line.end.y
        return Line(Point(sssx, sssy), Point(eeex, eeey))
    ...
    def reset(self):
        ...
        self.start.x = self.inpx.x
        self.start.y = self.inpx.y
        self.end.x = self.inpy.x
        self.end.y = self.inpy.y
