...
def test_make_simple_list():
    ...
    expected = [1, 2, 3]
    actual = make_simple_list(1, 3)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 3:
    expected = [3, 4, 5, 6, 7]
    actual = make_simple_list(3, 7)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def test_make_less_simple_string():
    ...
    # Test 2:
    expected = '3'
    actual = make_less_simple_string(3, 3)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range (len(circles)):
        a = rg.Square(circles[k].center, circles[k].radius * 2)
        rec = rec + [a]
    return rec
