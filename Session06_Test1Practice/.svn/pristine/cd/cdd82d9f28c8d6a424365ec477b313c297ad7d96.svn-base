...
def test_problem1a():
    ...
    # Test 4:
    expected = 0.178  # This is APPROXIMATELY the correct answer.
    answer = problem1a(-45, 876)
    print()
...
def test_problem1b():
    ...
    # Test 2:
    expected = 420  # This is APPROXIMATELY the correct answer.
    answer = problem1b(30, 100)
    print()
    ...
    # Test 4:
    expected = 8  # This is APPROXIMATELY the correct answer.
