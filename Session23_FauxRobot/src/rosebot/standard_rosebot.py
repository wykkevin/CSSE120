...
class MotorController(RobotComponent):
    ...
    def drive_pwm(self, left_wheel_pwm, right_wheel_pwm):
        ...
        """
        self.left_wheel_pwm(left_wheel_pwm)
        self.right_wheel_pwm(right_wheel_pwm)


    def left_wheel_pwm(self, left_wheel_pwm):
        control_signal_1 = SIGNAL.left_motor_control_1
        control_signal_2 = SIGNAL.left_motor_control_2
        pwm_signal = SIGNAL.left_motor_pwm
        self._wheel_pwm(control_signal_1, control_signal_2, pwm_signal,
                        left_wheel_pwm)

    def right_wheel_pwm(self, right_wheel_pwm):
        control_signal_1 = SIGNAL.right_motor_control_1
        control_signal_2 = SIGNAL.right_motor_control_2
        pwm_signal = SIGNAL.right_motor_pwm
        self._wheel_pwm(control_signal_1, control_signal_2, pwm_signal,
                        right_wheel_pwm)
