...
def main():
    ...
    if m1_tests.is_implemented('__init__', 2):
        test_init()
    if m1_tests.is_implemented('distance_from'):
        test_distance_from()
    if m1_tests.is_implemented('swell_or_shrink_once'):
        test_swell_or_shrink_once()
    if m1_tests.is_implemented('swell_or_shrink_repeatedly'):
...
class CircleChanger(object):
    ...
    def distance_from(self, point):
        ...
        Example: See   test_distance_from   below for examples.
        ...
        # DONE: 3.
        #   First, READ the green doc-string (specification) above.
        #   Second, READ the   test_distance_from   function
        ...
        return self.circle.center.distance_from(point)
    ...
    def swallow(self, other_circle_changer):
        ...
        point1 = self.circle.center.halfway_to(other_circle_changer.circle.center)
        radius1 = self.circle.center.distance_from(other_circle_changer.circle.center) / 2
        colors1 = self.colors + other_circle_changer.colors
        a = CircleChanger(point1.x, point1.y, radius1, 'red', colors1)
        return a
    ...
    def change_to_original_color(self):
        ...
        self.circle.fill_color = self.orifillcolor
    ...
    def change_to_next_color_in_tuple(self):
        ...
        if self.index0 < len(self.colors):
            self.circle.fill_color = self.colors[self.index0]
...
def test_distance_from():
    # Test1
    circle_changer = CircleChanger(60, 60, 100, 'blue', ('red', 'blue', 'green'))
    print ('Expected:', 70.71067812, 'Approximately')
    print ('Actual:', CircleChanger.distance_from(circle_changer, rg.Point(10, 10)))

    # Test2
    circle_changer = CircleChanger(80, 80, 100, 'blue', ('red', 'blue', 'green'))
    print ('Expected:', 1)
    print ('Actual:', CircleChanger.distance_from(circle_changer, rg.Point(80, 81)))

    # Test3
    circle_changer = CircleChanger(60, 60, 100, 'blue', ('red', 'blue', 'green'))
    print ('Expected:', 0)
    print ('Actual:', CircleChanger.distance_from(circle_changer, rg.Point(60, 60)))
