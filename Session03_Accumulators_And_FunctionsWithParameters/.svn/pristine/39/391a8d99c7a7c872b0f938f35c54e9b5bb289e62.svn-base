...
def test_better_draw_circles():
    ...
    print('--------------------------------------------------')
    better_draw_circles(1.1)
    better_draw_circles(11)
...
def test_even_better_draw_circles():
    ...
    print('--------------------------------------------------')
    even_better_draw_circles(1.1, 50, 300, 250, 'red', 0.1)
    even_better_draw_circles(5, 30, 178, 223, 'blue', 0.01)


def even_better_draw_circles(radii, number, xconcentric, yconcentric, outlinecolor, speed):
    window = rg.RoseWindow(400, 400)

    center = rg.Point(xconcentric, yconcentric)
