...
class Person(object):
    ...
    def give_money_to(self, other_person, amount_to_give):
        ...
        self.money = self.money - amount_to_give
        other_person.money = other_person.money + amount_to_give
        self.numofmoneygive = amount_to_give
    ...
    def make_baby_with(self, spouse, child_name):
        ...
        baby = Person(child_name, self.last_name, self.money / 2 + spouse.money / 2)
        self.money = self.money / 2
        spouse.money = spouse.money / 2
        return baby
