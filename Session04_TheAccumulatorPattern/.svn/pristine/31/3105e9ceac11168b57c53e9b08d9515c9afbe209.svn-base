...
def test_factorial():
    ...
    # Test 4:
    answer_from_oracle = math.factorial(324)
    answer_from_my_code = factorial(324)
...
def test_count_cosines_from():
    ...
    # Test 2:
    expected = 4
    answer = count_cosines_from(0, 9, 0.29)
    ...
    # Test 5:
    expected = 1057
    answer = count_cosines_from(64, 3234, 0.5)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 14361
    answer = count_cosines_from(0, 99999, 0.9)
...
def test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 6.853283  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 9000)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 0.281315  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(99, 130)
