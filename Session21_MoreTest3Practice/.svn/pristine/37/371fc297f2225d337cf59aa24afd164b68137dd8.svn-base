...
def test_problem2a():
    ...
    # ------------------------------------------------------------------
    # DONE: 2. Write tests for the  problem2a   function.
    ...
    # Test 1
    a = ([8, 4, 0, 9], [77, 0, 0, 1, 5, 0], [4, 4, 4], [4, 0, 4])
    b = ([8, 4, 1, 9], [77, 2, 3, 1, 5, 4], [4, 4, 4], [4, 5, 4])
    problem2a(a)
    print('Expected:', b)
    print('Actually:', a)

    # Test 2
    a = ([], [77, 0, 0, 1, 5, 0], [4, 4, 4], [4, 0, 4])
    b = ([], [77, 1, 2, 1, 5, 3], [4, 4, 4], [4, 4, 4])
    problem2a(a)
    print('Expected:', b)
    print('Actually:', a)

    # Test 3
    a = ([8, 4, 9], [77, 1, 5], [4, 4, 4], [4, 4])
    b = ([8, 4, 9], [77, 1, 5], [4, 4, 4], [4, 4])
    problem2a(a)
    print('Expected:', b)
    print('Actually:', a)
