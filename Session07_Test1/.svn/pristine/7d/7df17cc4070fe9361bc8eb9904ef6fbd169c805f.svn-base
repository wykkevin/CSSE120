...
def problem2(center_square, window):
    ...
    point11 = rg.Point(center_square.get_upper_right_corner().x,
                       (center_square.get_upper_right_corner().y -
                        center_square.get_height()))
    ...
    point22 = rg.Point((center_square.get_lower_left_corner().x
                       - center_square.get_width()),
                       center_square.get_lower_left_corner().y)
    ...
    point33 = rg.Point(center_square.get_lower_right_corner().x,
                       (center_square.get_lower_right_corner().y +
                       center_square.get_height()))
    ...
    point44 = rg.Point((center_square.get_lower_right_corner().x +
                        center_square.get_width()),
                       center_square.get_lower_right_corner().y)
