...
#            Calls 6 functions to test them and defines turtle.
#
...
def try_methods_and_functions():
    ...
    shi = rg.SimpleTurtle()
    shi.pen = rg.Pen('blue', 5)
    shi.speed = 1
    draw_many_squares(shi, 2, 100, 30)
    shi.speed = 5
    shi.pen = rg.Pen('red', 5)
    draw_many_squares(shi, 10, 50, 15)
    shi.speed = 100
    shi.pen = rg.Pen('red', 35)
    draw_many_squares(shi, 8, 300, 60)
    shi.pen = rg.Pen('black', 3)
    shi.backward(200)
    shi.draw_circle(30)
    shi.draw_square(50)
